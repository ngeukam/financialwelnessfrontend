...
const ManageUsers = ({ onSupplierSelect }) => {
    ...
    const getUsers = async () => {
        ...
        const result = await callApi({
            url: `auth/userlist/`, method: 'GET', params: {
    ...
    const generateColumns = (data) => {
        if (data.length > 0) {
            ...
            for (const key in data[0]) {
                if (key === 'profile_pic') {
                    columns.push({
                        field: 'profile_pic', headerName: 'Profile', width: 150, sortable: false, renderCell: (params) => {
                    ...
                    columns.push({
                        field: 'account_status', headerName: 'Status', width: 150, renderCell: (params) => {
                    ...
                    columns.push({
                        field: "addition_details", headerName: "Additional Details", width: 150, sortable: false, renderCell: (params) => {
                    ...
                    columns.push({
                        field: "social_media_links", headerName: "Social Links", width: 150, sortable: false, renderCell: (params) => {
